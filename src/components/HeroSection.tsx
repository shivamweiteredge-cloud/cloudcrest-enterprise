        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            <p className="text-lg text-primary-foreground/80 mb-8 max-w-xl">
              Your trusted Virtual business Partner for Streamlined Financial
              bookkeeping, Compliance, and Business Advisory. Focus on What
              Matters Most, While We Manage the Financial Complexities
            </p>
